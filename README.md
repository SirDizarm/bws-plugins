...
> **For the BoltWorks 3D Studio v50+ plugin system.** These packages do not install into the legacy edition (v49+). Check each plugin for its minimum required 50.x version.
>
